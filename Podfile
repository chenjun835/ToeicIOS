...
post_install do |installer|
    ...
    # disable deprecated warnings for Nimbus
    NIMBUS_FLAGS = "-Wno-deprecated"
    add_compiler_flags(installer.project, "NICSSRuleset.m", NIMBUS_FLAGS)
    add_compiler_flags(installer.project, "NIOverviewPageView.m", NIMBUS_FLAGS)
    add_compiler_flags(installer.project, "NIFormCellCatalog.m", NIMBUS_FLAGS)
    add_compiler_flags(installer.project, "NIAttributedLabel.m", NIMBUS_FLAGS)
    add_compiler_flags(installer.project, "UILabel+NIStyleable.m", NIMBUS_FLAGS)
end
